            ...
            if (!Character.isWhitespace(expression.charAt(i))) {
                ...
                if (expression.charAt(i) == 's' ||
                    ...
                    try {
                        ...
                        throw error("Expected first operand, but found beginning of expression");
                    }
                }
                if (unaryWhitespaceChecker(expression.charAt(i))) {
                    try {
                        ...
                        throw error("Expected expression after multi-char unary operator, but found end of expression");
                    }
                }
